...
<script src="{{asset('assets/principal/modules/jquery.min.js')}}"></script>
<script src="{{asset('assets/principal/modules/popper.js')}}"></script>
<script src="{{asset('assets/principal/modules/tooltip.js')}}"></script>
<script src="{{asset('assets/principal/modules/bootstrap/js/bootstrap.min.js')}}"></script>
...
<script src="{{asset('assets/principal/js/custom.js')}}"></script>
