...
<div class="row content">
    ...
    <div class="title-page-header">
        ...
        <div class="principal-container container-create-guide card-body card z-index-2">
            ...
            <a href="{{route('verificatorRejectedGuides.index')}}" class="btn btn-primary return-btn mb-2">
            ...
            <div class="mb-4">
                    ...
                    <form action="{{route('verificatorGuides.undoReject', $guide)}}" id="undoRejected-guide-form" method="POST">
                        @csrf
