...
<div class="row content">
    ...
    <div class="title-page-header">
        <div class="card page-title-container">
            <div class="card-header">
                <div class="total-width-container">
                    <h4>Revisar guía de Internamiento verificada</h4>
                </div>
            </div>
        </div>
        ...
        <div class="principal-container container-create-guide card-body card z-index-2">
            ...
            <a href="{{route('verificatorVerifiedGuides.index')}}" class="btn btn-primary return-btn mb-2">
